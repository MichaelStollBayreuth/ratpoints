...
Worth $6\%$ of \texttt{make test1}, $11\%$ of \texttt{make testhigh} and
$2.7\%$ of \texttt{make testhighmany},
at a loss of $1\%$ on \texttt{make test1many}, where the small moduli are
nearly silent. Larger moduli save more instructions and lose time: a row
