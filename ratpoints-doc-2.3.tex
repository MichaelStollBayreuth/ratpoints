...
used) in parallel. For this, we organize
...
Support for 32-bit machines has been retired: the code now assumes that
\texttt{long} has 64~bits and refuses to compile otherwise, and what used
