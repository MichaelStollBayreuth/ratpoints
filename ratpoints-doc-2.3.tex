...
fewer primes in the second stage, is better. That is thirteen settings in a
round rather than twenty-one,
...
non-zero sentinel written just past the range, and is a load, a test and a
branch. And the phase used to reach the table row of a surviving bit array
...
testhighmany}: the first by taking instructions out of the busiest short loop
of the program, the second by taking out branch mispredictions, which fall
by a fifth to a quarter at the large height bound.
