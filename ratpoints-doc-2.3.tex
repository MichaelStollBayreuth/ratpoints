...
least once: every degree from 1 to 100, odd and even, square and non-square
...
ranges and search intervals, height bounds from 1 to $2^{62}$ (those come
...
PARI/GP for the two searches that are too large for it).
