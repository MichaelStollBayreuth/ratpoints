...
another; the third stage keeps to primes, and at height bounds up to
$1000$ no table pays and nothing changes. The first phase of a random
curve at height~$16383$ uses $10$ moduli instead of $11.7$ primes and
performs $14\%$ fewer \texttt{AND}s. Worth $6\%$ of \texttt{make test1},
$11\%$ of \texttt{make testhigh} and $2.5\%$ of \texttt{make testhighmany},
