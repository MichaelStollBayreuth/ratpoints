...
of Legendre symbols: for $l = \pm 2^v \prod_i q_i^{e_i}$ it is
...
prime factor of~$l$; when $l$ has a prime factor above $1021$ it falls back
on the binary algorithm.
...
\texttt{make testhighmany} at the default code placement, and within a point of that at two other placements, and two thirds of the branch
