...
a bit of the bit arrays then stands for every second, fourth or eighth
integer, and the arrays are that much shorter. Before version~2.3 only the
...
denominators at half width, which is what the sieve sweeps for them: it was
...
got simpler. Worth $9\%$ of \texttt{make test1} ($7.5$ to $9\%$ at three
