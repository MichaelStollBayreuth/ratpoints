...
from $F(a,b) = a^D\, t^D f(1/t)$ with $t = b/a$ and $a$ odd, in place of
hand-derived congruences. The first phase needs half a prime less on
average and performs $4.5\%$ fewer \texttt{AND}s; it is worth $3\%$ of
\texttt{make test1} and of \texttt{make testhigh}, $1.5\%$ of \texttt{make
test1many}, about $1\%$ of \texttt{make testhighmany}, and between $2$
and $3\%$ at height bounds from $200$ to~$4000$. Modulo~$256$ would add a
fifth of the information for sixteen times the set-up and is not done.
