...
negative, the values compiled into \texttt{ratpoints.h} are used.
...
multiplication and a shift; measuring the two against each other inside one
binary makes the new form 2 to 3\% faster on all four test sets. The
measurement is worth stating the other way round as well: the hardware divider
was busy for at most $0.6\%$ of the run to begin with, so the divisions were
