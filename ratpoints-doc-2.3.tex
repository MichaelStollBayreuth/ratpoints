...
ones in hand run out (until version~2.3 it stopped at the first prime that
did not pay, which on one curve of \texttt{testdata-high-many.h} left it
with none). On those curves that turns one available prime into more than
twenty.
...
checks in place of $5000$. Now the stage looks at a further prime whenever
