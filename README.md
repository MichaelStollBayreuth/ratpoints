...
Support for 32-bit machines has been retired: the code assumes a 64-bit `long` and refuses to
compile without one. Version 2.2.4 is the last one that accommodates a 32-bit `long`.
