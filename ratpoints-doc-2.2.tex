...
Against the fixed values used up to version~2.2.3, this is about $7\%$ faster
on the random curves of \texttt{make test1} and about $33\%$ faster on the
point-rich curves of \texttt{make test1many}.
...
offset, which at large height bounds hardly matters at all. Use both tests:
