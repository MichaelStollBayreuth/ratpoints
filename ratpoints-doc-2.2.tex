...
that on your machine, no recompilation is needed:
\begin{verbatim}
> ./rptest -r 0.03 -R 5 -z
> ./rptest-many -r 0.03 -R 5 -z
\end{verbatim}
for a few values of each, minimising the sum of the two times; then put the
values you found into \texttt{ratpoints.h}. The threshold \verb+-r+ matters
considerably more than the offset \verb+-R+, which at large height bounds
hardly matters at all. Use both tests:
